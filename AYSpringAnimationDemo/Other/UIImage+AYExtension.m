...
@implementation UIImage (AYExtension)

+ (UIImage *)diagonalImageWithSize:(CGSize)size lineWidth:(CGFloat)lineWidth lineCap:(CGFloat)lineCap fillColor:(UIColor *)fillColor {
    ...
    CGFloat      tmpLineWidth = lineWidth == 0 ? 3 : lineWidth;
    CGFloat      tmpLineGap   = lineCap == 0 ? 1 : lineCap;
    
    CGContextTranslateCTM(context, 0.5 * drawLength, 0.5 * drawLength);
    CGContextRotateCTM(context, M_PI_4);
    CGContextTranslateCTM(context, -0.7 * drawLength, -0.35 * drawLength);
    [fillColor set];
